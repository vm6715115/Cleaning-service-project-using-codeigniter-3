    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-7 align-self-center">
                ...
                <h4 class="page-title">Gallery Update Images Form</h4>
            </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="form" method="POST" action="<?= base_url('Admin/update_image') ?>"
                            ...
                            <div class="form-group mt-5 row">
                                <label for="example-text-input" class="col-2 col-form-label text-dark">Image title
                                    :</label><br><br>
                                <input class="form-control border-secondary" type="text" name="image_title"
                                    value="<?= $data->image_title ?>" id="example-text-input"
