    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-7 align-self-center">
                ...
                <h4 class="page-title">Team Upload Images Form</h4>
            </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="form" method="POST" action="<?= base_url('Admin/add_team_image') ?>"
                            enctype="multipart/form-data">
                            <div class="form-group mt-5 row">
                                <label for="example-text-input" class="col-2 col-form-label text-dark">Name
                                    :</label><br><br>
                                <input class="form-control border-secondary" type="text" name="name" value=""
                                    id="example-text-input" placeholder="Enter name">
                            </div>
                            <br>

                            <div class="form-group mt-5 row">
                                <label for="example-text-input" class="text-dark">Designation :</label><br><br>
                                <input class="form-control border-secondary" type="text" name="designation" value=""
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form method="POST" action="<?= base_url('Admin/edit_team_image')?>">
                                            <input type="hidden" name="id" value="<?= $value->team_id ;?>">
                                    ...
                                    <td>
                                        <form method="POST" action="<?= base_url('Admin/delete_team_image')?>">
                                            <input type="hidden" name="id" value="<?= $value->team_id ;?>">
