     ...
     <div class="page-breadcrumb">
         <div class="row">
             <div class="col-7 align-self-center">
                 ...
                 <h4 class="page-title">Testimonial Update Images Form</h4>
             </div>
             ...
             <div class="col-sm-12">
                 <div class="card">
                     <div class="card-body">
                         ...
                         <form class="form" method="POST" action="<?= base_url('Admin/update_testimonial_image') ?>"
                             enctype="multipart/form-data">
                             <input type="hidden" name="id" value="<?= $data->testimonial_id; ?>">
                             <input type="hidden" name="t_image_name" value="<?= $data->t_image_name; ?>">
                             <div class="form-group mt-5 row">
                                 <label for="example-text-input" class="col-2 col-form-label text-dark">Update Name
                                     :</label><br><br>
                                 <input class="form-control border-secondary" type="text" name="t_name"
                                     value="<?= $data->t_name; ?>" id="example-text-input" placeholder="Enter Name">
                             </div>
                             <div class="form-group mt-5 row">
                                 <label for="example-text-input" class="col-2 col-form-label text-dark">Update
                                     Designation :</label><br><br>
                                 <input class="form-control border-secondary" type="text" name="t_designation"
                                     value="<?= $data->t_designation; ?>" id="example-text-input"
                             ...
                             <div class="form-group mt-5 row">
                                 ...
                                 <textarea class="form-control border-secondary" name="t_description" cols="" rows="5"
                                     placeholder="Type Here"><?= $data->t_description; ?></textarea>

                             </div>
                             <br>
                             <img src="<?= base_url($data->t_image_name);?>" alt="" style="width:200px;">
