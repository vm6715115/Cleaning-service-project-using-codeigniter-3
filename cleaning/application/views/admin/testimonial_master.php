...
<div class="page-wrapper">
                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Testimonial Master</li>
                        </ol>
                    </nav>
                </div>
                <h4 class="page-title">Testimonial Upload Images Form</h4>
            </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="form" method="POST" action="<?= base_url('Admin/add_testimonial_image') ?>"
                            enctype="multipart/form-data">
                            <div class="form-group mt-5 row">
                                <label for="example-text-input" class="col-2 col-form-label text-dark">Name
                                    :</label><br><br>
                                <input class="form-control border-secondary" type="text" name="t_name" value=""
                                    id="example-text-input" placeholder="Enter Name">

                            </div>
                            <div class="form-group mt-5 row">
                                <label for="example-text-input" class="col-2 col-form-label text-dark">Designation
                                    :</label><br><br>
                                <input class="form-control border-secondary" type="text" name="t_designation" value=""
                                    id="example-text-input" placeholder="Enter Designation">

                            </div>
                            <div class="form-group mt-5 row">
                                <label for="example-text-input" class="col-2 col-form-label text-dark">Description
                                    :</label><br><br>
                                <textarea class="form-control border-secondary" name="t_description" cols="" rows="5"
                            ...
                            <input type="file" name="t_image_name" class="form-control border-secondary"><br><br><br>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Testimonial images Table</h4>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $value->t_name ; ?></td>
                                    <td><?= $value->t_designation ; ?></td>
                                    <td><?= $value->t_description ; ?></td>
                                    <td><img src="<?= base_url($value->t_image_name); ?>" style="width: 200px;"></td>


                                    <td>
                                        <form method="POST" action="<?= base_url('Admin/edit_testimonial_image')?>">
                                            <input type="hidden" name="id" value="<?= $value->testimonial_id ;?>">
                                    ...
                                    <td>
                                        <form method="POST" action="<?= base_url('Admin/delete_testimonial_image')?>">
                                            <input type="hidden" name="id" value="<?= $value->testimonial_id ;?>">
                                            <input type="hidden" name="old_image" value="<?= $value->t_image_name ;?>">
